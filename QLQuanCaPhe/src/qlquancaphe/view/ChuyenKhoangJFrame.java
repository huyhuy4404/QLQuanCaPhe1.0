 ...
 * @author huydz
 */
public class ChuyenKhoangJFrame extends javax.swing.JFrame {
    ...
    /**
     * Creates new form ChuyenKhoangJFrame
     */
    public ChuyenKhoangJFrame() {
        initComponents();
        init();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChuyenKhoangJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChuyenKhoangJFrame().setVisible(true);
            }
        });
    }
